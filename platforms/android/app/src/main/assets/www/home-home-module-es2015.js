...
/* harmony import */ var _services_tmdb_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/tmdb.service */ "./src/app/services/tmdb.service.ts");
...
let HomePage = class HomePage {
    constructor(router, loadingCtrl, tmdb) {
        this.router = router;
    ...
    loadMovies() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const loading = yield this.loadingCtrl.create({ translucent: true, spinner: 'crescent', message: 'Cargando' });
            loading.present();
...
HomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        ...
        _services_tmdb_service__WEBPACK_IMPORTED_MODULE_3__["TmdbService"]])
], HomePage);
...
let TmdbService = class TmdbService {
    ...
    getParams(params) {
        const obj = Object.assign({}, this.params, params);
        const str = [];
        for (const p in obj) {
